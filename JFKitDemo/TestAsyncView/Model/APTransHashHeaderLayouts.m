...
//        img1.backgroundColor = JFRGBAColor(0x333333, 1);
        ...
        img4.imageSize = CGSizeMake(JFScaleWidth6(13), JFScaleWidth6(13));
        img4.index = 100;
